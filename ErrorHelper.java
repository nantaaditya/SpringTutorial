package com.example.demo.applicationdemo.helper;
...
public class ErrorHelper {
    ...
    public static Map<String, List<String>> from(Class<? extends ResourceNotFoundException> aClass, MessageSource messageSource) {
        return from(aClass, messageSource);
    }
}
